...
2. Realice un programa en C que permita obtener los factores primos de cualquier número.
*/
...
int numero; //Se declara la variable del número que vamos a examinar.
int factores[1000]; //Este será un arreglo para almacenar los factores de "numero".
